          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        context.pushNamed(RouteNames.auth.loginWith,
                            extra: true,
                            queryParameters: {"is_login_with_atom": "true"});
                      },
                    ),
                  ),
                ),
                ...
                GestureDetector(
                  onTap: () {
                    DialogManger.showHowToOpenAccountTutorial(context);
                  },
                  child: const Text(
